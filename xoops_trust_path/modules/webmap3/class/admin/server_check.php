<?php
// $Id: server_check.php,v 1.1.1.1 2012/03/17 09:28:12 ohwada Exp $
...
class webmap3_admin_server_check extends webmap3_lib_server_info
{
    ...
    /**
     * webmap3_admin_server_check constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @param $dirname
     * @param $trust_dirname
     * @return \webmap3_admin_server_check
     */
    ...
    /**
     * @param      $path
     * @param bool $need_first_slash
     * @param bool $need_last_slash
     * @param bool $flag_root_path
     * @return string
     */
    ...
    {
        // last char is slash
        if (mb_substr($dir, -1) == $this->_CHAR_SLASH) {
            if (!$need_last_slash) {
    ...
    public function build_path_dir($dir, $flag_root_path = false)
    {
        ...
        if (!is_dir($dir)) {
            ...
            if (0 === mb_strpos($dir, XOOPS_ROOT_PATH)) {
                $str .= "<br >\n";
