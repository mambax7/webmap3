...
// constructor
//---------------------------------------------------------
function webmap3_lib_multibyte()
{
...
// build summary
//---------------------------------------------------------
function build_summary( $str, $max, $tail=' ...' )
{
...
// wordwrap
//---------------------------------------------------------
function build_summary_with_wordwrap( $str, $max, $width, $break, $flag_sanitize )
{
	$str = $this->build_plane_text( $str );
...
function mb_wordwrap( $str, $width, $break, $flag_sanitize )
{
	if ( ! function_exists('mb_strlen') ) {
