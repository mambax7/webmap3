...
<head>
    <{* $Id: inc_get_location.html,v 1.1 2012/03/17 09:28:11 ohwada Exp $ *}>
    ...
    <script src="https://maps.google.com/maps/api/js?v=3&amp;key=<{$webmap3_api_key}>&amp;sensor=false&amp;language=<{$xoops_langcode}>" type="text/javascript" charset="utf-8"></script>
...
<div id="<{$map_div_id}>" style="<{$map_style}>">Loading ...</div>
<br>
