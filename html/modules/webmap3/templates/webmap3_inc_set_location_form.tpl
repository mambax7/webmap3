<{* $Id: webmap3_inc_set_location_form.tpl,v 1.1 2012/03/17 09:42:55 ohwada Exp $ *}>
    ...
    <table width='100%' class='outer' cellspacing='1'>
        ...
        <tr>
            ...
            <td class="even">
                ...
                <input type="text" id="webmap3_address" name="webmap3_address" value="<{$address|escape:'tpl'}>" size="50"/>
            </td>
        </tr>
        <tr>
